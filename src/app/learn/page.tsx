...
import { BookOpen, RotateCcw, Home, ArrowLeft, ArrowRight } from "lucide-react"
...
const japaneseChars: JapaneseChar[] = [
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card className="border-red-100 dark:border-red-800">
              <CardHeader>
                <CardTitle className="text-lg text-black dark:text-white">Navigation</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    disabled={currentIndex === japaneseChars.length - 1}
